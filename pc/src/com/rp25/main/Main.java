...
public class Main {
	...
	public static void main(String[] args) {
		...
		new JobSelection(JOBS, ITEMS, LOCATIONS, CANCELLATIONS, TRAINING_SET);
		...
		Point r3Start = new Point(11,1);
		Robot r3 = new Robot(3, (int) r3Start.getX(), (int) r3Start.getY());
		RouteIntegration routeStuff = new RouteIntegration(provider.read(DROP_LOCATIONS));
