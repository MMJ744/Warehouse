...
/**
 * A class that holds information about the state of the warehouse i.e. the
 * robot positions/jobs and job cancellations.
 * 
 * @author ass782
 *
 */
...
public class WarehouseState {
	...
	/*
	 * List of robots in the warehouse. Key: ID Number Value: Robot Object
	 */
	 ...
	 * 
	 * @param id
	 *            ID number of the desired robot
	...
	public String completedJobsString() {
		...
		for (Job j : getAllCompletedJobs()) {
			output.append(j.getName()).append("\r\n");
		}
