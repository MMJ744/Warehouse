...
import com.rp25.motion.behavior.GoForward;
...
public class BotMain {
	static BlockingQueue<Command> moveQueue = new BlockingQueue<Command>();
	static BlockingQueue<String> jobQueue = new BlockingQueue<String>();
	static BlockingQueue<Integer> feedbackQueue = new BlockingQueue<Integer>();
	...
	private static void initRobot(BlockingQueue<Command> moveQueue, BlockingQueue<Integer> feedbackQueue) {
		DifferentialPilot pilot = new DifferentialPilot(56, 110.5, Motor.C, Motor.A);
